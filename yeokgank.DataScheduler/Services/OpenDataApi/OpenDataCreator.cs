...
namespace yeokgank.DataScheduler.Services.OpenDataApi
{
    public class OpenDataCreator 
    {
        ...
        /// </summary>
        /// <param name="settings">요청변수</param>
        public static OpenData<ApartmentTradeData> ApartmentTradeInfo(Settings settings)
        {
            return new ApartmentTradeInfo(settings);
        }
        /// <summary>
        /// 국토교통부_공동주택 단지 목록제공 - 시군구 아파트 목록 수집
        /// </summary>
        /// <param name="settings">요청변수</param>
        public static OpenData<ApartmentListData> ApartmentListInfo(Settings settings)
        {
            return new ApartmentListInfo(settings);
        }
        /// <summary>
        /// 국토교통부_아파트 상세정보 조회
        /// </summary>
